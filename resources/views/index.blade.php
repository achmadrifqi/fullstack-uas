...
<body>
    ...
    <nav class="navbar  fixed-top navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <img class="nav-img" src="{{asset('assets/images/logo.png')}}" alt="" width="40">
            <a class="navbar-brand fs-4 ms-2" onclick="home()" href="#home">Aurora Travel.</a>
    ...
    <div class="jumbotron text-center" id="home">
        ...
        <h1 id="head-text">Aurora Travel.</h1>
    ...
    <footer class="mt-3">
            © 2021 Copyright:
            <a class="text-white" href="#">Aurora Travel</a>
